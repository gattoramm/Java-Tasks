...
public class Solution {
    ...
    public static void main(String[] args) throws Exception {
        ...
        switch (args[0]) {
            case "-c":
                birthdayDate = format.parse(args[3]);
                ...
                break;
            case "-u":
                birthdayDate = format.parse(args[4]);
                int id = Integer.parseInt(args[1]);
                //int id = allPeople.indexOf( findUsingEnhancedForLoop( args[1] ) );
            ...
            case "-d":
                ...
                //allPeople.remove(allPeople.indexOf(args[1]));
                person.setName(null);
                person.setSex(null);
